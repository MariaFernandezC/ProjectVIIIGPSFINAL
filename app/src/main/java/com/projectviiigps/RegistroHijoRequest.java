...
public class RegistroHijoRequest extends StringRequest {
    ...
    public RegistroHijoRequest(String nombreh, String apellidoh,  int edadh,String direccionh, String tiposangre, String enfermedad, String alergia, Response.Listener<String> listener) {
